...
- Tournament sync uses a separate same-origin BroadcastChannel adapter and local persistence. Cross-device real-time tournament transport and synced cast-preview timing were not validated in this release.
