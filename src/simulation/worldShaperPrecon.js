...
export const WORLD_SHAPER_PRECON = [
  ...
  {
    name: "World Shaper Ramp Permanent",
    typeLine: "Artifact",
    manaCost: "",
    role: "ramp",
    quantity: 10,
