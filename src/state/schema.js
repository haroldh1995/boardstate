...
export function createDefaultProfile() {
  return {
    ...
    settings: {
      ...
      aiGameplay: {
        enabled: true,
        preferredSimulationSpeed: "step-by-step",
        preferredInformationMode: "public-information",
        preferredDifficulty: "beta",
        explanationLevel: "intermediate",
        showThreatAnalysis: true,
        showBoardAnalysis: true,
    ...
    onboarding: {
      ...
      assistanceTokens: {
        version: "boardstate-contextual-assistance-0.1.0",
        dismissBehavior: "remember-and-respect",
      },
...
export function createGameSession() {
  ...
  return {
    ...
    aiGameplay: {
      ...
      enabled: true,
      informationMode: "public-information",
      activeProfileIds: [],
      latestDecision: null,
      threatAnalysis: null,
      boardAnalysis: null,
      ...
      analysisLog: [],
      memory: {
        version: "boardstate-ai-memory-0.1.0",
        enabled: true,
        preferredSimulationSettings: {
          informationMode: "public-information",
          speedMode: "step-by-step",
          opponentProfileIds: [],
        },
        preferredExplanationLevel: "intermediate",
        difficulty: "beta",
