...
export function boardStateProfileToSharedSession(profile = {}, options = {}) {
  ...
  return createSharedGameSession({
    ...
    activeInterfaceByPlayer: Object.fromEntries(players.map((player) => [player.playerId, player.activeInterface])),
    ...
    sessionCapabilities: {
      advancedBattlefield: true,
      rulesEngine: true,
      dryRun: true,
      tutorial: true,
      legacyBoardStateRuntime: true,
    },
    historyMetadata: {
